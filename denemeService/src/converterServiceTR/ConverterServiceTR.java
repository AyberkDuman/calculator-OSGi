...
public class ConverterServiceTR {
	...
	private static String[] singleDigit = {"sýfýr", "bir", "iki", "üç", "dört", "beþ", "altý", "yedi", "sekiz", "dokuz"};

	private static String[] tensDigits = {"", "on", "yirmi", "otuz", "kýrk", "elli", "altmýþ", "yetmiþ", "seksen", "doksan"};
	    
	 
	// convert isleminde kullanilacak methodlarin tanýmlarý.
	...
	private static String convertHundreds(int number) {
		...
		String hundredResult = singleDigit[number / 100] + " yüz";
	 ...
	 // convert islemini yapan ana method.
	    ...
	    public static String convertNumberToWords(int number) {
	        ...
	        if (number >= 0 && number <= 9) { //0,1,...9
	            ...
	            throw new IllegalArgumentException("TAM SAYÝ DEÐÝL");
